...
class WU_Addon_Updater {
  ...
  public function get_update_URL() {
    ...
    return "https://nextpress.co/versions/updates/?action=get_metadata&slug=$this->plugin_slug";
  ...
  public function enable_update_checker() {
    ...
    if ($validation_status && $validation_status->success && $validation_status->purchase->refunded == false) {
      ...
      $updateChecker = PucFactory::buildUpdateChecker(
        $this->get_update_URL() . "&license_key=$validation_status->license_key",  // Metadata URL.
